    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 footer3 mt-5">
                <a href="{{ url('/') }}"> <img src="{{ asset($footer_logo->img) }}" class="img-fluid" alt="img"> </a>
                <div class="footer1">
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3  mt-5 ">
                <h4 class="mb-4 links">QUICK LINKS</h4>
                <ul class="footer2">
                    <li><a href="{{ route('consumers') }}">Consumers</a></li>
                    <li><a href="{{ route('businesses') }}">Businesses</a></li>
                    <li><a href="{{ route('sales.professionals') }}">Sales-professionals</a></li>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3  mt-5">
                <h4 class="mb-4 links">CONTACT US</h4>
                <div class="footer3">
                    <h6>Address</h6>
                    <p>{{ $setting->address ?? '' }}</p>
                    <h6>Email Address</h6>
