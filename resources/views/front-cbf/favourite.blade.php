...
@section('content')
    ...
    <section class="toppanel-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="top-head">
                        <h2><span><a href="javascript:;"></a></span>Favourites</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="favrit-sect">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="categ-content">
                        <div class="row">
                            @forelse($processedLikedBusinesses as $key => $business)
                                <div class="col-md-6">
                                    <div class="dine-cont">
                            ...
                            @empty
                                <div class="col-md-12">
                                    <div class="dine-cont">
                                        <h3 class="text-dark">Favourites Not Found.</h3>
                                    </div>
                                </div>
                            @endforelse
                        </div>
