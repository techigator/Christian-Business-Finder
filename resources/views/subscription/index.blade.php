                        ...
                        <div class="col-12 align-self-center">
                            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                                <div class="w-sm-100 mr-auto">
                                    <h4 class="mb-0">Subscription Listing</h4>
                                </div>
                                <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}" class="text-dark">Home</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('subscription.index') }}"
                                                                       class="text-dark">Subscription Listing</a>
                                        </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="card">
                                <div class="card-header justify-content-between align-items-center flex-btn">
                                    <h4 class="card-title">Subscription Listing</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="form-delete">
                                                            ...
                                                            <button type="submit" class="btn btn-danger delete_button" data-id="{{ $subscription->id }}">
                                                    ...
                                                    <nav aria-label="Page navigation">
                                                        <ul class="pagination justify-content-center">
                                                            ...
                                                            @else
                                                                <li class="page-item">
                                                                    <a class="page-link"
                                                                       href="{{ $subscriptions->previousPageUrl() }}"
                                                            ...
                                                            @if ($subscriptions->hasMorePages())
                                                                <li class="page-item">
                                                                    <a class="page-link"
                                                                       href="{{ $subscriptions->nextPageUrl() }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="document-content">
                    ...
                    @endif
                    <form action="{{ route('subscription.store') }}" class="add-form" method="POST"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subscription_amount" id="subscription-amount" class="form-control mt-2 mb-2"
                                           placeholder="Subscription Amount" value=""/>
    ...
    <script>
        $(document).ready(function () {
            $('.delete_button').click(function (e) {
                ...
                var url = "{{ route('subscription.delete') }}" +'/'+ subscription_id;

                swal({
                    title: `Are you sure?`,
                    text: "If you delete this subscription amount, it will be gone forever.",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
