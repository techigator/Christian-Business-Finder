        ...
        <tr>
            <td style="width: 100%; margin: 0; padding: 0; background-color: #F2F4F6;" align="center">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <!-- Logo -->
                    <tr>
                        <td style="padding: 25px 0;text-align: center;background: #E75C5B;">
                            <a target="_blank" rel="noopener noreferrer" style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="{{url('/')}}"><img src="{{asset('assets/images/logo.png')}}"></a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                            ...
                                            <a style="color: #3869D4;" href="javascript:;" target="_blank">{{ env('APP_NAME') }}</a>.
                                            {{ 'All rights reserved.' }}
                                        </p>
                                    </td>
                                </tr>
